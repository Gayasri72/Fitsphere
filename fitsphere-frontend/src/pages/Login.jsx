...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      {/* Left side: Image and words, no blue background */}
      <div className="hidden md:flex flex-col justify-center items-center w-1/2">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIx6sH_QH0gxtadyyMe4D8lClKTckewc1dcw&s" // Replace with your logo or desired image
          alt="FitSphere Logo"
        ...
        <p className="text-2xl text-gray-600 font-semibold text-center max-w-md drop-shadow">
          Connect with friends and the fitness world around you on FitSphere.
        </p>
      </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-300 focus:outline-none bg-blue-50 text-gray-800"
              />
            </div>
            <div>
              <label
              ...
              <input
                ...
                required
                className="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-indigo-300 focus:outline-none bg-indigo-50 text-gray-800"
              />
            </div>
            <button
              type="submit"
